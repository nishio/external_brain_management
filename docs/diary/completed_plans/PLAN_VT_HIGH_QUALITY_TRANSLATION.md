...
**✅ 完了日**: 2025-11-15
**実装**: `modules/mem/scripts/translate_vt_pages.ts`, `modules/mem/scripts/move_vt_translations.ts`
**使用方法**: `make vt-translate` → `make vt-move`（Makefileのvt-translate, vt-moveターゲットで実行）
**翻訳エンジン**: OpenAI gpt-4o（DeepLからアップグレード）
**移動日**: 2025-11-25
